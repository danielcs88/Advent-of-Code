...
def part_one(input_str: str) -> str:
    return "".join(
        ...
        for column in aoc_transpose_list_of_lists(
            [list(row) for row in input_str.splitlines()]
        )
    )


# %%
assert part_one(example) == example_answer

# %%
aoc_answer_display(part_one(input_06))
...
# %%
aoc_answer_display(part_two(input_06))
