...
def sum_contiguous_numbers(array: str) -> list[int]:
    r"""
    _summary_
    ...
    list[int]
    """
    return (sum(int(x) for x in i) for i in (_.split() for _ in array.split("\n\n")))


# %%
part_1 = open("input_01.txt", encoding="utf-8").read()
# part_1 = get_data(day=1, year=2022)
sol_1 = max(sum_contiguous_numbers(part_1))
print(sol_1)
...
# %%
part_2 = sorted(sum_contiguous_numbers(part_1))[-3:]
sol_2 = sum(part_2)
print(sol_2)
