...
# each step, you'll need to update the position of the tail if the step means
# the head is no longer adjacent to the tail. Visually, these motions occur as
...
# %%
def move(h, t):
    # print("MOVE") print("h", h) print("t", t) print(f"h - t {h-t}")
...
input_09 = open_input("input_09.txt")
...
# series of motions. Each knot further down the rope follows the knot in front
...
# %%
test_2 = """R 5
U 8 L 8 D 3 R 17 D 10 L 25 U 20"""


# %%
def p2(f):
    rope = [lol((0, 0)) for _ in range(10)]
    pos = set()
